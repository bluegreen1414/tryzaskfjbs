package com.kapirti.social_chat_food_video.ui.presentation.player.preloadmanager
...
private constructor(
    ...
    private var mediaItemsList = listOf<ExplorePhotoVideo>()
    ...
    fun init(mediaList: List<ExplorePhotoVideo>) {
    ...
    private fun setMediaList(mediaList: List<ExplorePhotoVideo>) {
