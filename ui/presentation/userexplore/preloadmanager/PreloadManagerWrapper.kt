package com.kapirti.social_chat_food_video.ui.presentation.userexplore.preloadmanager
...
private constructor(
    ...
    private var mediaItemsList = listOf<ExploreUserItem>()
    ...
    fun init(mediaList: List<ExploreUserItem>) {
    ...
    private fun setMediaList(mediaList: List<ExploreUserItem>) {
