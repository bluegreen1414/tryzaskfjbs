...
class PreloadManagerWrapperStory
private constructor(
    ...
    private var mediaItemsList = listOf<StoryItem>()
    ...
    companion object {
        fun build(
            ...
            return PreloadManagerWrapperStory(preloadManager)
        }
    }

    /** Add initial list of videos to the preload manager. */
    fun init(mediaList: List<StoryItem>) {
    ...
    private fun setMediaList(mediaList: List<StoryItem>) {
