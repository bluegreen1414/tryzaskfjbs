...
class RestaurantWorker @Inject constructor(
    ...
    override fun doWork(): Result {
        val randomid = inputData.getString(FirestoreServiceImpl.FLIRT_COLLECTION) ?: return Result.failure()
        val uid = inputData.getString(FirestoreServiceImpl.MARRIAGE_COLLECTION) ?: return Result.failure()
        val photoFile = inputData.getString(FirestoreServiceImpl.LANGUAGE_PRACTICE_COLLECTION) ?: return Result.failure()
