...
class HotelWorker @Inject constructor(
    ...
    override fun doWork(): Result {
        ...
        val uid = inputData.getString(FirestoreServiceImpl.FLIRT_COLLECTION) ?: return Result.failure()
        val photoFile = inputData.getString(FirestoreServiceImpl.MARRIAGE_COLLECTION) ?: return Result.failure()
