...
class EditViewModel @Inject constructor(
    ...
    fun onDonePressed(restartAppEdit: () -> Unit, restartAppUsers: () -> Unit) {
        ...
        launchCatching {
            _selfieUri?.let {
                ...
                val inputData = workDataOf(
                    FirestoreServiceImpl.CAFE_COLLECTION to randomUid.toString(),
                    FirestoreServiceImpl.RESTAURANT_COLLECTION to uid.toString(),
                    FirestoreServiceImpl.HOTEL_COLLECTION to it.value.toString(),
    ...
    private fun saveMarriage(restartAppUsers: () -> Unit) {
        launchCatching {
            _selfieUri?.let {
                ...
                val uid = accountService.currentUserId
                val inputData = workDataOf(
                    FirestoreServiceImpl.HOTEL_COLLECTION to randomUid.toString(),
                    FirestoreServiceImpl.RESTAURANT_COLLECTION to uid.toString(),
                    FirestoreServiceImpl.CAFE_COLLECTION to it.value.toString(),
                    FirestoreServiceImpl.COUNTRY_FIELD to _country.value.toString(),
                    FirestoreServiceImpl.USERNAME_FIELD to _username.value.toString(),
                    FirestoreServiceImpl.BIRTHDAY_FIELD to _birthday.value.toString(),
                    FirestoreServiceImpl.GENDER_FIELD to _gender.value.toString(),
    ...
    private fun saveHotel(restartAppUsers: () -> Unit) {
        launchCatching {
            _selfieUri?.let {
                ...
                val inputData = workDataOf(
                    FirestoreServiceImpl.CAFE_COLLECTION to randomUid.toString(),
                    FirestoreServiceImpl.FLIRT_COLLECTION to uid.toString(),
                    FirestoreServiceImpl.MARRIAGE_COLLECTION to it.value.toString(),
                    FirestoreServiceImpl.COUNTRY_FIELD to _country.value.toString(),
                    FirestoreServiceImpl.USERNAME_FIELD to _username.value.toString(),
    ...
    private fun saveRestaurant(restartAppUsers: () -> Unit) {
        launchCatching {
            _selfieUri?.let {
                ...
                val uid = accountService.currentUserId
                val inputData = workDataOf(
                    FirestoreServiceImpl.FLIRT_COLLECTION to randomUid.toString(),
                    FirestoreServiceImpl.MARRIAGE_COLLECTION to uid.toString(),
                    FirestoreServiceImpl.LANGUAGE_PRACTICE_COLLECTION to it.value.toString(),
                    FirestoreServiceImpl.COUNTRY_FIELD to _country.value.toString(),
                    FirestoreServiceImpl.USERNAME_FIELD to _username.value.toString(),
                    FirestoreServiceImpl.CITY_FIELD to _birthday.value.toString(),
                    FirestoreServiceImpl.ADDRESS_FIELD to _gender.value.toString(),
    ...
    private fun saveCafe(restartAppUsers: () -> Unit) {
        launchCatching {
            _selfieUri?.let {
                ...
                val uid = accountService.currentUserId
                val inputData = workDataOf(
                    FirestoreServiceImpl.DESCRIPTION_FIELD to randomUid.toString(),
                    FirestoreServiceImpl.HOTEL_COLLECTION to uid.toString(),
                    FirestoreServiceImpl.RESTAURANT_COLLECTION to it.value.toString(),
                    FirestoreServiceImpl.COUNTRY_FIELD to _country.value.toString(),
                    FirestoreServiceImpl.USERNAME_FIELD to _username.value.toString(),
                    FirestoreServiceImpl.CITY_FIELD to _birthday.value.toString(),
                    FirestoreServiceImpl.ADDRESS_FIELD to _gender.value.toString(),
